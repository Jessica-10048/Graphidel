                    ...
                    <a href="#" className="cta-button dark">Browse Templates</a> 
                     ...
                     <section className="collage-gallery">
                       <h2>Be Inspired by Our Collages</h2>
                        <p className="gallery-intro">Here are some creative ideas made using Graphidel tools. Tap the button to see more free collage templates!</p>
                         <div className="collage-grid"> 
                          ...
                          </div> <a href="#" className="cta-button dark">View All Collages</a> 
                          </section>
                                ...
                                <img src={DSC08657} alt="5cm Punch Tool"/>
                                 <h3>Collage activities with CreatCut punch - 5cm circle</h3>
                                  <p className="price">£23.99</p>
                                   <a href="#" className="cta-button dark">View Product</a> 
                                   </div>
