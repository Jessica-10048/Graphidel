...
// Debug: log pour vérifier que la route est chargée
...
router.post("/create-checkout-session", async (req, res) => {
  console.log("🎯 create-checkout-session hit"); // Debug
  
  try {
    const { cartItems, customer = {} } = req.body;
    console.log("📦 cartItems:", cartItems?.length || 0); // Debug
    ...
    console.log("🔗 CLIENT_URL:", CLIENT_URL); // Debug
    ...
    console.log("✅ Session created:", session.id); // Debug
...
router.get("/test", (req, res) => {
  res.json({ message: "Payment router works!" });
});
